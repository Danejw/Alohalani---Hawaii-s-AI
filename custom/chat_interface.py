...
🌺 Mahalo nui loa! 🌺""")
    ...
    if user_input:        
        ...
        with col1:
            st.write("<div style='text-align: center'><a href='" + link1 + "'>Buy Me Coffee ☕️</a></div>", unsafe_allow_html=True)

        with col2:
            st.write("<div style='text-align: center'><a href='" + link2 + "'>Fuel My Creativity ❤️🔥</a></div>", unsafe_allow_html=True)
